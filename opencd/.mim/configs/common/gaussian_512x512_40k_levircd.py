...
dataset_type = 'LEVIR_CD_GS_Dataset'
crop_size = (512, 512)
train_pipeline = [
    dict(type='MultiImgLoadImageFromFile'),
    dict(type='MultiImgMultiAnnLoadAnnotations_Gaussian'),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            img_path_to='train/B',
            gaussian_map_path='train/gaussian_maps'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            img_path_from='val/A',
            img_path_to='val/B',
            gaussian_map_path='val/gaussian_maps'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            img_path_to='test/B',
            gaussian_map_path='test/gaussian_maps'),
        pipeline=test_pipeline))
