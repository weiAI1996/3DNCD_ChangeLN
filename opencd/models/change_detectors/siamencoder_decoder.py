...
class SiamEncoderDecoder(BaseSegmentor):
    ...
    def __init__(self,
        ...
        # if neck is not None:
        self.neck1 = cross_feature_3d(in_channels=64*2)
        self.neck2 = cross_feature_3d(in_channels=128*2)
        self.neck3 = cross_feature_3d(in_channels=256*2)
        self.neck4 = cross_feature_3d(in_channels=512*2)
    ...
    def extract_feat(self, inputs: Tensor) -> List[Tensor]:
        ...
        # for x_ in feat_from:
        #     print(x_.shape)
        x.append(self.neck1([feat_from[0], feat_to[0]]))
        x.append(self.neck2([feat_from[1], feat_to[1]]))
        x.append(self.neck3([feat_from[2], feat_to[2]]))
        x.append(self.neck4([feat_from[3], feat_to[3]]))
