...
class _BaseGSCDDataset(BaseDataset):
    ...
    def __init__(self,
        ...
        self.gau_map_suffix = gau_map_suffix
    ...
    def load_data_list(self) -> List[dict]:
        ...
        ann_dir_gs = self.data_prefix.get('gaussian_map_path', None)
        if osp.isfile(self.ann_file):
            ...
            for line in lines:
                ...
                if ann_dir is not None:
                    ...
                    ann_name_gau = ann_name_gau + self.gau_map_suffix
                    data_info['seg_map_path'] = osp.join(ann_dir, seg_map)
                    data_info['gaussian_map_path'] = osp.join(ann_dir_gs, ann_name_gau)
            ...
            for img in fileio.list_dir_or_file(
                ...
                if ann_dir is not None:
                    ...
                    ann_name_gau  = img.replace(self.img_suffix, self.gau_map_suffix)
                    data_info['seg_map_path'] = osp.join(ann_dir, seg_map)
                    data_info['gaussian_map_path'] = osp.join(ann_dir_gs, ann_name_gau)
                data_info['label_map'] = self.label_map
                data_info['format_seg_map'] = self.format_seg_map
